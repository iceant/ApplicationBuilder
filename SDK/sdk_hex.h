...
////////////////////////////////////////////////////////////////////////////////
////
sdk_size_t sdk_hex_encode(char* buffer, uint32_t offset, sdk_size_t buffer_size, const uint8_t *data
        , sdk_size_t data_offset, sdk_size_t data_size, bool isUpperCase, sdk_byteorder_t byteOrder);

sdk_size_t sdk_hex_decode(uint8_t *buffer, sdk_size_t buffer_offset, sdk_size_t buffer_size
        , const char* hex, sdk_size_t hex_offset, sdk_size_t hex_size);
